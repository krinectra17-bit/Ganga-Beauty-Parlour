...
- Name: production-audit.spec.js >> production audit >> layout integrity at 1280px
- Location: production-audit.spec.js:7:5

# Error details

```
Error: overflowing elements at 1280px
...
+       "left": -25.5999755859375,
+       "right": 1305.5999755859375,
+       "top": 0,
+       "width": 1331.199951171875,
+       "x": -25.5999755859375,
+       "y": 0,
+     },
+     "tag": "IMG",
...
+       "left": -5.89385986328125,
+       "right": 1285.8937377929688,
+       "top": -5.737396240234375,
+       "width": 1291.78759765625,
+       "x": -5.89385986328125,
+       "y": -5.737396240234375,
+     },
+     "tag": "IMG",
