...
- Name: production-audit.spec.js >> production audit >> layout integrity at 375px
- Location: production-audit.spec.js:7:5

# Error details

```
Error: overflowing elements at 375px
...
+     "id": "",
+     "rect": Object {
+       "bottom": 902.9504089355469,
+       "height": 909.5950927734375,
+       "left": -1.9989776611328125,
+       "right": 376.9989471435547,
+       "top": -6.644683837890625,
+       "width": 378.9979248046875,
+       "x": -1.9989776611328125,
+       "y": -6.644683837890625,
+     },
+     "tag": "IMG",
+   },
